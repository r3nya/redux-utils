...
exports['default'] = function (action) {
  ...
  try {
    _validateActionName2['default'](action.name);
  } catch (e) {
  ...
  var unknownProperty = _utils2['default'].first(_utils2['default'].difference(_utils2['default'].keys(action), ['name', 'data', 'metadata', 'error']));
  if (unknownProperty) {
